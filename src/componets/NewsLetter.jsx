        ...
        <div className=" flex flex-col items-center justify-center py-10 px-20 bg-[#F9F8F5]">
            ...
            <motion.div
                ...
                <div className="flex flex-col space-y-2 flex-1">
                    <h1 className='text-xl md:text-2xl lg:text-4xl font-bold'>Subscribe to our <br />
                        Newsletter!</h1>
                    <p className='mt-2 text-gray-500 text-sm md:text-xl'>Be the first to get exclusive offers
